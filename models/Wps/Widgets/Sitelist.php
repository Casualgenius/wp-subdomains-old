...
class Wps_Widgets_Sitelist
{
    ...
    function control ()
    {
        ...
        if (! empty($_POST['csd-sitelist-submit'])) {
            ...
            // isset($_POST['ace-categories-hierarchical']);
...
<p>
	<label for="sitelist-title">
					<?php _e( 'Title:' ); ?>
					<input class="widefat" id="sitelist-title"
		name="csd-sitelist-title" type="text" value="<?php echo $title; ?>" />
	</label>
</p>
...
<p>
	<label for="sitelist-main">
					<?php _e( 'Site Home:' ); ?>
					<input class="widefat" id="sitelist-main" name="csd-sitelist-main"
		type="text" value="<?php echo $main; ?>" />
	</label>
</p>
<p>
	<!--
				...
				<br />
			-->
	<label for="categories-count"> <input type="checkbox" class="checkbox"
		id="categories-count" name="ace-categories-count"
		<?php checked( $count, true ); ?> />
...
<?php
    ...
    function display ($args)
    {
        ...
        $c = $options['count'] ? '1' : '0';
        /*
         * $h = $options['hierarchical'] ? '1' : '0'; $d = $options['dropdown']
         * ? '1' : '0';
         */
